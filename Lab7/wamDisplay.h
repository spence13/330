...
//these are the display colors
#define WAMDISPLAY_GREEN DISPLAY_GREEN
#define WAMDISPLAY_BLACK DISPLAY_BLACK
#define WAMDISPLAY_WHITE DISPLAY_WHITE
#define WAMDISPLAY_RED DISPLAY_RED

//these are the text sizes
#define WAMDISPLAY_TEXT_SIZE_TWO 2
#define WAMDISPLAY_TEXT_SIZE_THREE 3
#define WAMDISPLAY_TEXT_SIZE_FOUR 4
#define WAMDISPLAY_TEXT_SIZE_FIVE 5
#define WAM_DISPLAY_CHAR_HEIGHT 7
#define WAM_DISPLAY_CHAR_WIDTH 4

//these are the display screen sizes
#define WAMDISPLAY_PIXEL_WIDTH 320
#define WAMDISPLAY_PIXEL_HEIGHT 240
#define WAMDISPLAY_HALF_PIXEL_WIDTH 320/2
#define WAMDISPLAY_HALF_PIXEL_HEIGHT 240/2
#define WAMDISPLAY_FOURTH_PIXEL_WIDTH 320/4
#define WAMDISPLAY_FOURTH_PIXEL_HEIGHT 240/4
#define WAMDISPLAY_THIRD_PIXEL_WIDTH 320/3
#define WAMDISPLAY_TWO_THIRD_PIXEL_WIDTH (320/3)*2
#define WAMDISPLAY_THIRD_PIXEL_HEIGHT 240/3
#define WAMDISPLAY_TWO_THIRD_PIXEL_HEIGHT (240/3)*2
#define WAMDISPLAY_FIFTH_PIXEL_WIDTH 320/5

//these deal with the various board sizes
#define WAMDISPLAY_BOARD_SIZE_NINE 9
#define WAMDISPLAY_BOARD_SIZE_SIX 6
#define WAMDISPLAY_BOARD_SIZE_FOUR 4

//these deal with the 3 rows and columns on the board
#define WAMDISPLAY_BOARD_ROW_ONE 1
#define WAMDISPLAY_BOARD_ROW_TWO 2
#define WAMDISPLAY_BOARD_ROW_THREE 3
#define WAMDISPLAY_BOARD_COL_ONE 1
#define WAMDISPLAY_BOARD_COL_TWO 2
#define WAMDISPLAY_BOARD_COL_THREE 3

//these are the hole sizes and locations
#define WAMDISPLAY_HOLE_RADIUS 20
#define WAMDISPLAY_HOLE_XPOS_ONE 320/4
#define WAMDISPLAY_HOLE_XPOS_TWO 320/2
#define WAMDISPLAY_HOLE_XPOS_THREE 320*.75
#define WAMDISPLAY_HOLE_YPOS_ONE 240/4
#define WAMDISPLAY_HOLE_YPOS_TWO 240/2
#define WAMDISPLAY_HOLE_YPOS_THREE 240*.75

//these are the game screen sizes
#define WAMDISPLAY_BACKGROUND_OFFSET 10
#define WAMDISPLAY_BACKGROUND_OFFSET_DOUBLE 20
#define WAMDISPLAY_BACKGROUND_OFFSET_QUADRUPLE 40

//these deal with print statements
#define WAMDISPLAY_SCORE_BOARD "Hit:0    Miss:0   Level:0\n\r"
#define WAMDISPLAY_WAC_START_SCREEN "Wack A Mole\n\r"
#define WAMDISPLAY_WAC_START_TOUCH "touch screen to start\n\r"
#define WAMDISPLAY_GAME_OVER_SCREEN "game over\n\r"
#define WAMDISPLAY_GAME_OVER_HITS "Hits:"
#define WAMDISPLAY_GAME_OVER_MISSES "Misses: "
#define WAMDISPLAY_GAME_OVER_LEVEL "Final Level: "
#define WAMDISPLAY_GAME_OVER_RETOUCH "(touch to try again)\n\r"

//these are positioning of print statements
#define WAMDISPLAY_FIVE_HITS 5
#define WAMDISPLAY_X_PIXEL_POS_HITS 6
#define WAMDISPLAY_X_PIXEL_POS_MISS 21
#define WAMDISPLAY_X_PIXEL_POS_LEVEL 36

//random initialization of variables
#define WAMDISPLAY_RUN_TEST_ONE_LOOP 1
#define WAMDISPLAY_RUN_TEST_TWO_LOOP 1
#define WAMDISPLAY_CHAR_LENGTH 20
#define WAMDISPLAY_INCREMENT_ACTIVE_MOLES 1
